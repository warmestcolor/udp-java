...
public class Tester {
    ...
    private void assertEquals(String s, int length, int headerLength) {
        System.out.println("AssertEqual: " + s + ": " + (length == headerLength));
    }
    ...
    public void assertTrue(boolean v) {
        System.out.println("AssertTrue: " + v);
    }

    public static void main(String[] args) throws Exception {
        Tester t = new Tester();
        t.setUp();
        t.testDeserializeQuery();
        t.testIGMPv2();
    }
}
