...
public class EthType {
    ...
    public enum EtherType {
        ...
        ARP(0x806, "arp", igmp.packet.ARP.deserializer()),
        RARP(0x8035, "rarp", igmp.packet.ARP.deserializer()),
        IPV4(0x800, "ipv4", IPv4.deserializer()),
        IPV6(0x86dd, "ipv6", IPv6.deserializer()),
        LLDP(0x88cc, "lldp", igmp.packet.LLDP.deserializer()),
        VLAN(0x8100, "vlan", null),
        QINQ(0x88a8, "qinq", null),
        BDDP(0x8942, "bddp", igmp.packet.LLDP.deserializer()),
        MPLS_UNICAST(0x8847, "mpls_unicast", MPLS.deserializer()),
        MPLS_MULTICAST(0x8848, "mpls_multicast", MPLS.deserializer()),
        EAPOL(0x888e, "eapol", igmp.packet.EAPOL.deserializer()),
